    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Now put an agent in the middle of that sentence. The page renders, the shopping agent accesses the full disclosure, a model compresses it, and a human reads the compression. Has the consumer accessed the information? Ontario law does not appear to answer that, and I am not going to pretend it does. What is striking is that a provision drafted in 2002, for a web nobody expected software to shop on, frames the question this precisely.",
          "Read the three together and a pattern falls out. Each describes something a person is supposed to see, and something a person is supposed to do about it. None of them contemplates that the seeing and the doing might be carried out by software the buyer switched on that morning.",
      ...
      },
      {
        ...
        body: [
          ...
          "The flight in C1 is a harder case than that, and for a different reason than I first assumed. Passenger transport is largely carved out of the Consumer Rights Directive altogether under Article 3(3)(k), rather than sitting inside the withdrawal regime as an exception to it, and the Commission has said the withdrawal right does not apply to air passenger services. The intuition survives — a mistaken agentic purchase of a flight has no generic cooling-off period to fall back on — but the mechanism is exclusion from the directive rather than an exception within it. Worth knowing which, because the two behave differently across other categories.",
